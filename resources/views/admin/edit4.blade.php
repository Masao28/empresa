...
<body class="bg-gray-100 text-gray-800">
 ...
 <center>
  <h1 class="text-3xl text-center pt-1">Editar tipo de vihiculo</h1>

  <form action="{{route('salvar4',['id_tipoVehiculo'=>$vehiculotipo->id_tipoVehiculo])}}" method="POST">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
 ...
 <TABLE BORDER CELLPADDING=20 CELLSPACING=10>
    ...
    <TD> <div class="col-sm-10">
        <input name="nombre" type="text" class="form-control" id="inputMotor" placeholder="Nombre del motor"value="{{$vehiculotipo->nombre}}">
      </div>
    </TD> 
